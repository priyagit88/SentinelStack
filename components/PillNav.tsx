...
// Adapted from React Bits "PillNav" (JS + CSS variant) for Next.js App Router:
//  - uses next/link instead of react-router-dom
//  - supports action items (onClick, no href) so things like "Logout" can live
//    in the pill nav as a <button>
...
const PillNav = ({
  ...
  // Inner content shared by link / anchor / button pills.
  const pillInner = (item: PillNavItem, i: number) => (
    <>
      <span
